    ...
    <section className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-white/80 max-w-2xl">
          Tell us a bit about your project and we’ll get back to you quickly. We
          serve residential and commercial clients across NYC.
        </p>
      </header>
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            <label className="block text-sm text-white/70" htmlFor="timeframe">
              Timeframe
            </label>
            <select
              id="timeframe"
        ...
        <p className="text-xs text-white/60">
          By submitting, you agree to be contacted about your request. We don’t
          sell your data.
        </p>
      </form>
    </section>
